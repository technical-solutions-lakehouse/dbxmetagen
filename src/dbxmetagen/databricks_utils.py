...
def setup_widgets(dbutils):
    ...
    dbutils.widgets.text("output_catalog_name", "")
    dbutils.widgets.text("output_schema_name", "")
...
def get_widgets(dbutils):
    ...
    catalog_name = dbutils.widgets.get("output_catalog_name")
    schema_name = dbutils.widgets.get("output_schema_name")
